  ...
  return (
    <div className='bg-white h-fit w-full flex flex-col items-center gap-5 p-3 lg:my-7'>
        <div className='flex flex-col items-center px-2'>
          ...
          <p className='font-bold text-[27px] lg:text-[53px] lg:tracking-wider'>Explore Cowork Through Our</p>
          <div className='flex items-center'>
              <img className='h-9 w-20 lg:h-14 lg:w-40 rounded-[50px] shadow-md shadow-zinc-400/90' src={img} alt="embeded" />
              <p className='font-bold text-[27px] lg:text-[53px] lg:tracking-wider'>&nbsp;Lens</p>
          </div>
        </div>
